...
## <p><h2 align="center">Application that lists github repositories developed on the ReactJS Track in [Rocketseat](https://app.rocketseat.com.br/dashboard) Ignite</h2> </p>
...
<h3 align="center">
  In this application we use the GitHub api to handle basic ReactJS concepts such as components, properties, state, and immutability.
</h3>

<br>

## :information_source: Application installation
- `git clone https://github.com/mathwcruz/github-explorer.git` to clone the repository

<br>

# 🎲 Run application
To run the application on the web, follow the instructions from your terminal:
- `cd github-explorer` and `code .`
